...
struct ContentView: View {
    ...
    // These values store softest decibel levels the user can hear. They are used to set the gain on the EQ bands.
    ...
    func populateLowestAudibleDecibelBandsArrays () {
        profile_1_lowestAudibleDecibelBands = [StoredValues.shared.lowestAudibleDecibelBand60L_1, StoredValues.shared.lowestAudibleDecibelBand60R_1, StoredValues.shared.lowestAudibleDecibelBand100L_1, StoredValues.shared.lowestAudibleDecibelBand100R_1, StoredValues.shared.lowestAudibleDecibelBand230L_1, StoredValues.shared.lowestAudibleDecibelBand230R_1, StoredValues.shared.lowestAudibleDecibelBand500L_1, StoredValues.shared.lowestAudibleDecibelBand500R_1, StoredValues.shared.lowestAudibleDecibelBand1100L_1, StoredValues.shared.lowestAudibleDecibelBand1100R_1, StoredValues.shared.lowestAudibleDecibelBand2400L_1, StoredValues.shared.lowestAudibleDecibelBand2400R_1, StoredValues.shared.lowestAudibleDecibelBand5400L_1, StoredValues.shared.lowestAudibleDecibelBand5400R_1, StoredValues.shared.lowestAudibleDecibelBand12000L_1, StoredValues.shared.lowestAudibleDecibelBand12000R_1]
        profile_2_lowestAudibleDecibelBands = [StoredValues.shared.lowestAudibleDecibelBand60L_2, StoredValues.shared.lowestAudibleDecibelBand60R_2, StoredValues.shared.lowestAudibleDecibelBand100L_2, StoredValues.shared.lowestAudibleDecibelBand100R_2, StoredValues.shared.lowestAudibleDecibelBand230L_2, StoredValues.shared.lowestAudibleDecibelBand230R_2, StoredValues.shared.lowestAudibleDecibelBand500L_2, StoredValues.shared.lowestAudibleDecibelBand500R_2, StoredValues.shared.lowestAudibleDecibelBand1100L_2, StoredValues.shared.lowestAudibleDecibelBand1100R_2, StoredValues.shared.lowestAudibleDecibelBand2400L_2, StoredValues.shared.lowestAudibleDecibelBand2400R_2, StoredValues.shared.lowestAudibleDecibelBand5400L_2, StoredValues.shared.lowestAudibleDecibelBand5400R_2, StoredValues.shared.lowestAudibleDecibelBand12000L_2, StoredValues.shared.lowestAudibleDecibelBand12000R_2]
    }
    
    // Call this on startup to set the current profile:
    
    func setCurrentProfile () {
        currentProfile = StoredValues.shared.currentProfile
    }
    
    func setCurrentIntensity () {
        currentIntensity = StoredValues.shared.currentIntensity
    }
    ...
    func setEQBandsGain () {
        ...
        let multiplyer1: Double = (1 / abs(minValue - maxValue))
        let multiplyer2: Double = (8 / abs(minValue - maxValue))
        let multiplyer3: Double = (16 / abs(minValue - maxValue))
